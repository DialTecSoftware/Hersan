...
namespace Hersan.Resolver
{
    ...
    internal class RegisterComponent : IRegisterComponent
    {
        ...
        public void RegisterTypeWithHierarchicalLifetime<TFrom, TTo>(bool withInterception = false) where TTo : TFrom
        {
        ...
        {
            return this._container.RegisterType<T>(new HierarchicalLifetimeManager());
        }
