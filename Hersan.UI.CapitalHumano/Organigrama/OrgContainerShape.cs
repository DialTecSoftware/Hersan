...
namespace Hersan.UI.CapitalHumano.Organigrama
{
    ...
    {
        //public RadToggleButtonElement toggleCollapseButton;
        private const int BottomOffset = 25;
        private bool isUpdating = false;
        private System.Drawing.Color baseColor;
        private bool showCollapseButton = false;
        ...
        public OrgContainerShape()
        {
            ...
            this.ToggleCollapseButton.ToggleState = Telerik.WinControls.Enumerations.ToggleState.On;
        ...
        public void Colapsar()
        {
            ...
            ((OrgHeaderPresenterElement)this.HeaderPresenter).DrawFill = this.IsCollapsed;
        ...
        public void ToggleCollapseButton_ToggleStateChanging(object sender, StateChangedEventArgs args)
        {
        }

        public void ToggleCollapseButton_ToggleStateChanged(object sender, StateChangedEventArgs args)
        {
            ...
            if (args.ToggleState == Telerik.WinControls.Enumerations.ToggleState.On) {
                ...
                this.ToggleCollapseButton.Text = "▶";
                //MessageBox.Show(args.ToggleState.ToString() + "serye");
        ...
        {
            this.TeamMembers = string.Format("{0} Miembros", this.Items.Count);
            this.MinHeight = 0;
