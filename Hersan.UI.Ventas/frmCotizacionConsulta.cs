...
{
    public partial class frmCotizacionConsulta : Telerik.WinControls.UI.RadForm
    {
        WCF_Catalogos.Hersan_CatalogosClient oCatalogos;
        WCF_Ensamble.Hersan_EnsambleClient oEnsamble;

        public frmCotizacionConsulta()
        {
            InitializeComponent();
        }
        private void frmCotizacionConsulta_Load(object sender, EventArgs e)
        {
            try {
